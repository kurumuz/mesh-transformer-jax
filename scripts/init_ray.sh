...
sudo pip3 install --upgrade jaxlib jax==0.2.12 ray==1.2.0 fabric dataclasses optax==0.0.6 git+https://github.com/deepmind/dm-haiku tqdm cloudpickle smart_open[gcs] einops func_timeout